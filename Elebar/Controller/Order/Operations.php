...
class Operations extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if(method_exists(\Rollpix\Elebar\Controller\Order\Operations::class,$functionName)) {
    ...
    public function purchase(){
        ...
        if($quoteId){
            ...
            if($result['success']){
                ...
                $response['url'] = sprintf('elebar/page/pay?orderid=%s&orderkey=%s',$result['order_id'],$orderKey);
            }
            else{
