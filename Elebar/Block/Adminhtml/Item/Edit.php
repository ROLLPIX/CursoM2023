...
namespace Rollpix\Elebar\Block\Adminhtml\Item;
...
class Edit extends Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Rollpix_Elebar';
        $this->_controller = 'adminhtml_Item';

        parent::_construct();

        if ($this->_isAllowedAction('Rollpix_Elebar::gateway_item_save')) {
        ...
        if ($this->_isAllowedAction('Rollpix_Elebar::gateway_item_delete')) {
