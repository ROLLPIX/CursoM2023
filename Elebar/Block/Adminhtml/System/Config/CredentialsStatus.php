...
namespace Rollpix\Elebar\Block\Adminhtml\System\Config;
...
class CredentialsStatus extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    {
        return '<tr id="row_' . $element->getHtmlId() . '" class="row_payment_other_elebar_validation_credentials">' . $html . '</tr>';
    }
}