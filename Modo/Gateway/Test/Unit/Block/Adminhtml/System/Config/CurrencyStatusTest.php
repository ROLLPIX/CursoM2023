...
use Modo\Gateway\Block\Adminhtml\System\Config\CurrencyStatus;
...
class CurrencyStatusTest  extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetElementHtmlOnSuccess(){
        ...
        $_getElementHtmlTestMethod = new \ReflectionMethod(
            \Modo\Gateway\Block\Adminhtml\System\Config\CurrencyStatus::class,
            '_getElementHtml'
        );
    ...
    public function testDecorateRowHtml(){
        $expected = '<tr id="row_test-id" class="row_payment_other_modo_validation_credentials">html_test</tr>';
