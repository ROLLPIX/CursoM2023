<?php
namespace Modo\Gateway\Test\Unit\Model\Service;
...
class OrderServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Modo\Gateway\Model\Service\OrderService
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->invoiceOrderMock = $this->getMockBuilder(InvoiceOrderInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->modoServiceMock = $this->getMockBuilder(ApiService::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->orderService = new \Modo\Gateway\Model\Service\OrderService(
    ...
    public function testPurchaseActionWithNumericQuote(){
        $quoteId = 1;
        $this->modoHelperMock->method('getNewOrderStatus')->willReturn('pending');
    ...
    public function testGeneratePaymentIntention(){
        $this->modoServiceMock->method('createPaymentIntention')->willReturn(['response-test']);
    ...
    public function testGeneratePaymentIntentionWithException(){
        $this->modoServiceMock->method('createPaymentIntention')->willThrowException(new NoSuchEntityException(__('Exception')));
    ...
    public function testApproveOrder(){
        ...
        $this->modoHelperMock->method('getApprovedOrderStatus')->willReturn('processing');
        $this->orderMock->method('getQuoteId')->willReturn(1);
    ...
    public function testCancelOrderWithCancelFlagAndCanCancel(){
        $this->modoHelperMock->method('canCancelOnFailure')->willReturn(true);
    ...
    public function testCancelOrderWithoutCancelFlag(){
        $this->modoHelperMock->method('canCancelOnFailure')->willReturn(false);
        $this->orderMock->method('getQuoteId')->willReturn(1);
    ...
    public function testGetOrderByAttributeWithId(){
        $getOrderByAttributeTestMethod = new \ReflectionMethod(
            \Modo\Gateway\Model\Service\OrderService::class,
            'getOrderByAttribute'
        );
