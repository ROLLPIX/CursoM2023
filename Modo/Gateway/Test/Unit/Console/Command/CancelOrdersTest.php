<?php
namespace Modo\Gateway\Test\Unit\Console\Command;
...
class CancelOrdersTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Modo\Gateway\Console\Command\CancelOrders
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->orderServiceFactoryMock = $this->createMock(\Modo\Gateway\Model\Service\OrderServiceFactory::class);
        ...
        $this->cancelOrdersCommand = new \Modo\Gateway\Console\Command\CancelOrders($this->stateMock,$this->orderServiceFactoryMock, $this->timezoneMock,null);
    }

    public function testConfigure(){
        $configureTestMethod = new \ReflectionMethod(
            \Modo\Gateway\Console\Command\CancelOrders::class,
            'configure'
        );
