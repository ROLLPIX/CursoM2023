...
class Edit extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Modo_Gateway::gateway_item_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Modo_Gateway::item')
            ...
            ->addBreadcrumb(__('Manage Gateway Posts'), __('Manage Gateway Item'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Modo\Gateway\\Model\Item');
