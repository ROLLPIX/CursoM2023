...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Rollpix_Shipping::shipping')
            ->addBreadcrumb(__('Shipping'), __('Shipping'))
            ->addBreadcrumb(__('Manage Methods'), __('Manage Methods'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create( \Rollpix\Shipping\Model\ShippingMethod::class );
        ...
        $this->_coreRegistry->register('methods', $model);
